...
// Total de registros
$totalSql = "SELECT COUNT(*) as total FROM livros";
...
$sql = "SELECT * FROM livros ORDER BY id_livro ASC LIMIT $max OFFSET $offset";
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="update.php?id=<?php echo $row['id_livro']; ?>" class="nav-item btn btn-outline-dark">Editar Livro</a> |
                                    <a href="delete.php?id=<?php echo $row['id_livro']; ?>" onclick="return confirm('Tem certeza que deseja excluir?')" class="nav-item btn btn-outline-dark">Excluir Livro</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
